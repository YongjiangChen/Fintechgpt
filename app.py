...
import os
os.environ["HF_TOKEN"] = "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"
os.environ["FINNHUB_API_KEY"] = "cmtbak9r01qqtangmk0gcmtbak9r01qqtangmk10"
...
base_model = AutoModelForCausalLM.from_pretrained("daryl149/llama-2-7b-chat-hf")
